...
.. important::
    ...
    This documentation describes esp-idf-kconfig version 3.x, which is used in ESP-IDF 6.x. For documentation of esp-idf-kconfig version 2.x, which is used in ESP-IDF 5.x, see the `esp-idf-kconfig v2.x documentation <https://docs.espressif.com/projects/esp-idf-kconfig/en/release-v2/>`_ or pick from the dropdown in the upper left corner.
